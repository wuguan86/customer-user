...
function SettingsPage(props) {
  ...
  const saveTask = async (returnToList) => {
    ...
    try {
      ...
      setFormData({
        ...
        knowledgeBaseId: taskData.knowledgeBaseId
      });
      setBoundKnowledgeBaseId(taskData.knowledgeBaseId || "");
      if (returnToList) {
        setView("list");
      }
      fetchTasks();
  ...
  const handleUploadKnowledgeFiles = async () => {
    ...
    for (let i = 0; i < total; i += 1) {
      ...
      try {
        ...
        const data = res;
        const newKnowledgeBaseId = data?.knowledgeBaseId;
        ...
        setUploadStatus("上传失败: " + (err.message || "Unknown error"));
  ...
  const ToggleSwitch = ({ checked, onChange }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `switch-wrapper ${checked ? "running" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `switch-component ${checked ? "active" : ""}`, onClick: onChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "switch-knob" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "switch-label", children: checked ? "运行中" : "暂停" })
  ] });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-page", children: [
    view === "list" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "list-view", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "任务列表" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "create-btn", onClick: () => {
          setEditingTask(null);
          setFormData({
            name: "",
            content: "",
      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading", children: "加载中..." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "task-list", children: tasks.map((task) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-info", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "task-name", children: task.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "task-type", children: task.type })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-actions", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleEdit(task), children: "编辑" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleDelete(task.id), children: "删除" })
        ] })
      ] }, task.id)) })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-view", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "back-btn", onClick: () => setView("list"), children: "← 返回" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: editingTask ? "编辑任务" : "新建任务" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-content", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "任务名称" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "任务类型" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              value: formData.type,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "长期任务", children: "长期任务" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "临时任务", children: "临时任务" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Prompt 内容" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prompt-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: openTemplateModal, children: "从模板选择" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "知识库绑定" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kb-binding-area", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kb-status", children: [
              "当前绑定 ID: ",
              boundKnowledgeBaseId || "无"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: openKnowledgeModal, children: boundKnowledgeBaseId ? "重新上传知识库" : "上传知识库文件" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "save-btn", onClick: handleSave, children: "保存" }) })
      ] })
    ] }),
    isTemplateModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "选择模板" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsTemplateModalOpen(false), children: "X" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-body", children: templates.map((tpl) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "template-item", onClick: () => handleApplyTemplate(tpl), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tpl-name", children: tpl.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tpl-preview", children: [
          tpl.content.slice(0, 50),
          "..."
        ] })
      ] }, tpl.id)) })
    ] }) }),
    isKnowledgeModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal kb-modal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "知识库文件上传" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: closeKnowledgeModal, children: "X" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kb-upload-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-list", children: selectedFiles.map((file, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "file-name", children: file.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "file-size", children: [
            (file.size / 1024).toFixed(1),
            " KB"
          ] }),
          !isUploading && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "remove-btn", onClick: () => handleRemoveFile(file), children: "删除" })
        ] }, index)) }),
        isUploadPanelOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "upload-area", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "拖拽文件到这里，或" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "file-input-label", children: [
                  "点击选择文件",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "cancel-upload-btn", onClick: () => setIsUploadPanelOpen(false), children: "取消" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "upload-actions", children: [
          uploadStatus && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "upload-status", children: uploadStatus }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
        ...
        .switch-component.active .switch-knob {
          left: 22px;
        }
        .switch-label {
          font-size: 0.9em;
        ...
        .switch-wrapper.running .switch-label {
          color: #4a90e2;
        }
