  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-surface", children: [
    ...
    isModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "wechat-modal-mask", role: "dialog", "aria-modal": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "wechat-modal", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "wechat-modal-body", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "wechat-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary", type: "button", onClick: refreshQrCode, disabled: isLoadingQr, children: isLoadingQr ? "刷新中..." : "刷新二维码" }) })
      ] })
    ] }) })
  ] }) });
}
...
function App() {
  ...
  const [backendBaseUrl, setBackendBaseUrl] = reactExports.useState(localStorage.getItem("backendBaseUrl") || AppConfig.apiBaseUrl);
  const [tenantId, setTenantId] = reactExports.useState(localStorage.getItem("tenantId") || AppConfig.defaultTenantId);
