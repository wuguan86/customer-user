      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "app-nav", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "✨ 视界AI运营助手" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "📋 任务设置" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "👤 我的" })
          }
        )
      ] })
    ] }),
...
function AssistantPage(props) {
  ...
  reactExports.useEffect(() => {
    ...
    if (isMonitoring && captureBounds) {
      const api = window.api;
      const monitorLoop = async () => {
        if (!isMonitoring) return;
        try {
          const captureResult = await api.doCapture(captureBounds);
          if (!captureResult) {
          ...
          if (!rawText || rawText.includes("识别失败")) {
            monitoringTimeoutRef.current = setTimeout(monitorLoop, 2e3);
            return;
          }
          const cleanText = getCleanText(items, bounds) || rawText;
          if (cleanText.trim() === lastProcessedTextRef.current.trim()) {
            monitoringTimeoutRef.current = setTimeout(monitorLoop, 2e3);
            return;
          }
          ...
          setOcrItems(items);
          await sendToDifyWithText(cleanText, items, bounds, true);
          monitoringTimeoutRef.current = setTimeout(monitorLoop, 5e3);
        } catch (e) {
          monitoringTimeoutRef.current = setTimeout(monitorLoop, 5e3);
        }
      };
  ...
  }, [isMonitoring, captureBounds, userToken, tenantId, backendBaseUrl]);
  const toggleMonitoring = () => {
    if (!captureBounds) {
      alert("请先进行一次截图以确定监控区域");
      return;
    }
    setIsMonitoring(!isMonitoring);
  };
  const sendToDifyWithText = async (text, items = [], bounds = null, isAuto = false) => {
    if (!text) return;
    if (!userToken) {
      alert("请先登录");
      onNavigateSettings();
    ...
    if (isAuto && items && items.length > 0 && bounds) {
      const speaker = getLastSpeaker(items, bounds);
      if (speaker === "ME") {
        setDifyResponse("检测到最后一条消息是我发送的，待命");
        return;
      }
    }
    setIsSending(true);
    setDifyResponse("AI 正在思考...");
    const prompt = `
你是一个微信客服助手。以下是识别到的聊天记录（包含对方的消息和我的消息）：
---
${text}
---
请严格遵守以下规则：
1. 仔细分析上下文，判断最后一条消息是谁发的。
2. 如果最后一条消息是“我”发的，或者对方没有提出新问题，请直接回复“无”。
3. 如果最后一条消息是对方发的，请针对该消息生成一句合适的回复。
4. 回复内容必须完整，不要截断。
5. 语气自然，模拟真人客服。
6. 直接输出回复内容，不要包含任何解释、引号或前缀。
    `.trim();
    try {
      const body = {
        inputs: {
      ...
      const response = await axios.post(`${backendBaseUrl}/api/user/dify/chat-messages`, body, {
        headers: getTransitHeaders()
      });
      if (response.data.conversation_id) {
        setConversationId(response.data.conversation_id);
      }
      const reply = response.data.answer || "无回复";
      setDifyResponse(reply);
      if (reply.trim() === "无") {
        setDifyResponse("AI 建议：无 (无需回复)");
        return;
      }
      if (bounds && items.length > 0) {
        const delayMs = Math.max(500, reply.length * 100);
        setDifyResponse(reply + `
(正在模拟真人输入... 等待 ${(delayMs / 1e3).toFixed(1)} 秒)`);
        await new Promise((resolve) => setTimeout(resolve, delayMs));
        const sendBtn = items.find((item) => item.text.includes("发送") || item.text.includes("Send"));
        const dpr = window.devicePixelRatio || 1;
        let sendCoords = void 0;
        let focusCoords = void 0;
        if (sendBtn && sendBtn.box) {
          const box = sendBtn.box;
          const centerX_physical = (box[0][0] + box[2][0]) / 2;
          const centerY_physical = (box[0][1] + box[2][1]) / 2;
          const boundsX_physical = bounds.x * dpr;
          const boundsY_physical = bounds.y * dpr;
          sendCoords = {
            x: boundsX_physical + centerX_physical,
            y: boundsY_physical + centerY_physical
          };
          focusCoords = {
            x: sendCoords.x - 20,
            y: sendCoords.y - 60
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-header-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: { backgroundColor: isMonitoring ? "#ff4d4f" : "" },
            children: isMonitoring ? "🔴 停止自动监控" : "🟢 开启自动监控"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary", onClick: handleStartCapture, children: captureBounds ? "重新框选区域" : "开始截图识别" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: "1000px", margin: "0 auto" }, children: [
      capturedImage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { style: { marginTop: 0, marginBottom: "15px" }, children: "截图预览" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: capturedImage,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { display: "flex", flexDirection: "column", gap: "20px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { style: { marginTop: 0, marginBottom: "10px" }, children: "识别文字" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              value: ocrResult,
              ...
              style: { width: "100%", height: "100px", padding: "12px", boxSizing: "border-box" }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "10px", textAlign: "right" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary", onClick: sendToDify, disabled: isSending || !ocrResult, children: isSending ? "AI 处理中..." : "发送给 Dify" }) })
        ] }),
        difyResponse && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid #eee", paddingTop: "20px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { style: { marginTop: 0, marginBottom: "10px" }, children: "AI 建议" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
...
function LoginPage(props) {
  const { backendBaseUrl, setBackendBaseUrl, tenantId, setTenantId, onLoginSuccess } = props;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-surface", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "login-close", type: "button", onClick: () => setShowConfig((v2) => !v2), children: showConfig ? "×" : "⚙" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-brand", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-logo", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-logo-mark", children: "识流" }) }),
    ...
    showConfig && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-config", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-config-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-config-label", children: "后端地址" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "login-config-input", value: backendBaseUrl, onChange: (e) => setBackendBaseUrl(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "login-config-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "login-config-label", children: "租户ID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "login-config-input", value: tenantId, onChange: (e) => setTenantId(e.target.value) })
      ] })
    ] }),
    isModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "wechat-modal-mask", role: "dialog", "aria-modal": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "wechat-modal", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "wechat-modal-body", children: [
        ...
        loginState && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "wechat-state", children: [
          "state: ",
          loginState
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "wechat-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary", type: "button", onClick: refreshQrCode, disabled: isLoadingQr, children: isLoadingQr ? "刷新中..." : "刷新二维码" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary", type: "button", onClick: () => setShowConfig(true), style: { backgroundColor: "#2f3b52" }, children: "配置" })
        ] })
      ] })
    ] }) })
  ] }) });
...
function MePage(props) {
  ...
  reactExports.useEffect(() => {
    const fetchMe = async () => {
      ...
      setError("");
      try {
        const response = await axios.get(`${backendBaseUrl}/api/user/me`, {
    ...
    if (backendBaseUrl && tenantId && userToken) {
      fetchMe();
    }
  }, [backendBaseUrl, tenantId, userToken]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "page-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "page-title", children: "我的" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-header-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary", style: { backgroundColor: "#ff4d4f" }, onClick: onLogout, children: "退出登录" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { maxWidth: "800px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { style: { marginTop: 0 }, children: "账号信息" }),
        loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "加载中..." }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#ff4d4f" }, children: error }),
        me2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "16px", alignItems: "center" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
              ...
              children: me2.avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: me2.avatarUrl, alt: "avatar", style: { width: "100%", height: "100%", objectFit: "cover" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#999" }, children: "👤" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { lineHeight: 1.8 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "昵称：" }),
              me2.nickname || "-"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "用户ID：" }),
              me2.id
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "租户ID：" }),
              me2.tenantId
            ] })
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { maxWidth: "800px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { style: { marginTop: 0 }, children: "连接信息" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { lineHeight: 1.8 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "后端：" }),
            backendBaseUrl
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "租户：" }),
            tenantId
          ] })
        ] })
      ] })
...
function SettingsPage(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "page-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "page-title", children: "任务设置" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", style: { display: "flex", flexDirection: "column", gap: "20px", maxWidth: "1000px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "8px", fontSize: "14px", fontWeight: "bold" }, children: "任务名称" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "8px", fontSize: "14px", fontWeight: "bold" }, children: "任务内容" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid #eee", paddingTop: "20px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { fontSize: "14px", fontWeight: "bold" }, children: "知识库文档管理" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "12px", backgroundColor: "#f9f9f9", padding: "15px", borderRadius: "8px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "10px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "file",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "label",
            {
              ...
              style: {
                ...
                padding: "8px 16px",
                backgroundColor: isUploading ? "#ccc" : "#1890ff",
                color: "white",
                borderRadius: "4px",
                fontSize: "14px"
              },
          ...
          uploadStatus && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "12px", color: uploadStatus.includes("失败") ? "red" : "green" }, children: uploadStatus })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid #eee", paddingTop: "20px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { style: { marginTop: 0, marginBottom: "15px" }, children: "系统配置" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "15px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "8px", fontSize: "14px" }, children: "中转后端地址" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "15px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "8px", fontSize: "14px" }, children: "租户 ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "15px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "8px", fontSize: "14px" }, children: "用户 Token" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "password",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", marginBottom: "8px", fontSize: "14px" }, children: "知识库 ID (Dataset ID)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "10px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: handleBindKnowledgeBase,
              style: {
                padding: "8px 16px",
                borderRadius: "4px",
...
function App() {
  ...
  const [backendBaseUrl, setBackendBaseUrl] = reactExports.useState(localStorage.getItem("backendBaseUrl") || "http://localhost:8081");
  const [tenantId, setTenantId] = reactExports.useState(localStorage.getItem("tenantId") || "1");
  const [userToken, setUserToken] = reactExports.useState(localStorage.getItem("userToken") || "");
  reactExports.useEffect(() => {
  ...
  const activeRoute = route === "capture" ? "assistant" : route;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { activeRoute, onNavigate: navigate, children: [
    activeRoute === "assistant" && /* @__PURE__ */ jsxRuntimeExports.jsx(AssistantPage, { backendBaseUrl, tenantId, userToken, onNavigateSettings: () => navigate("settings") }),
