...
function SettingsPage(props) {
  const { backendBaseUrl, setBackendBaseUrl, tenantId, setTenantId, userToken, setUserToken } = props;
  const [taskName, setTaskName] = reactExports.useState(localStorage.getItem("taskName") || "");
  const [taskDescription, setTaskDescription] = reactExports.useState(localStorage.getItem("taskDescription") || "");
  const [datasetId, setDatasetId] = reactExports.useState(localStorage.getItem("datasetId") || "");
  ...
  }, [taskName, taskDescription, datasetId]);
  const getTransitHeaders = () => {
    const headers = { "X-Tenant-Id": tenantId };
    if (userToken) {
      headers["Authorization"] = `Bearer ${userToken}`;
  ...
  const checkIndexingStatus = async (documentId, currentDatasetId, retryCount = 0) => {
    try {
      const response = await axios.get(
        `${backendBaseUrl}/api/user/dify/datasets/${currentDatasetId}/documents/${documentId}`,
        { headers: getTransitHeaders() }
      );
      const docStatus = response.data;
      const status = docStatus.indexing_status || docStatus.display_status;
      if (status === "completed") {
        setUploadStatus("上传并索引完成！");
      } else if (status === "error") {
        setUploadStatus(`索引失败: ${docStatus.error || "未知错误"}`);
      } else {
        setUploadStatus(`正在索引中... (${status})`);
        setTimeout(() => checkIndexingStatus(documentId, currentDatasetId, 0), 2e3);
      }
    } catch (err) {
      ...
      if (err.response?.status === 404 && retryCount < 10) {
        setUploadStatus(`正在等待文档索引初始化... (${retryCount + 1}/10)`);
        setTimeout(() => checkIndexingStatus(documentId, currentDatasetId, retryCount + 1), 2e3);
        return;
      }
      setUploadStatus("检查索引状态失败: " + (err.response?.data?.message || err.message));
    }
  };
  const handleFileUpload = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${backendBaseUrl}/api/user/dify/datasets/${cleanDatasetId}/document/create-by-file`,
        formData,
        { headers: getTransitHeaders() }
      );
      const documentId = response.data.document?.id;
      if (documentId) {
        setUploadStatus("上传成功！正在开始索引...");
        setTimeout(() => checkIndexingStatus(documentId, cleanDatasetId), 2e3);
      } else {
        setUploadStatus("上传成功，但未获取到文档 ID。");
      }
      e.target.value = "";
    } catch (err) {
      if (err.response?.status === 401) {
  ...
  const handleBindKnowledgeBase = async () => {
    ...
    try {
      await axios.put(`${backendBaseUrl}/api/user/dify/kb`, { knowledgeBaseId: cleanDatasetId }, { headers: getTransitHeaders() });
      alert("已绑定知识库 ID 到当前账号");
    } catch (err) {
      if (err.response?.status === 401) {
        setUserToken("");
        return;
      }
      alert("绑定失败: " + (err.response?.data?.message || err.message));
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page settings-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "page-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-header-title-group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "page-title", children: "任务设置" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-subtitle", children: "用于配置长期任务与知识库" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-layout", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card settings-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "settings-card-title", children: "任务名称" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-card-subtitle", children: "简短清晰的名称便于识别" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-card-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "任务名称" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card settings-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "settings-card-title", children: "任务内容" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-card-subtitle", children: "描述任务目标与执行方式" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-card-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "任务内容" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "textarea-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card settings-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-card-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "settings-card-title", children: "知识库文档管理" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-card-subtitle", children: "上传资料并绑定到当前账号" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-card-actions", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "file",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "label",
              {
                ...
                className: `btn-ghost-purple ${isUploading ? "btn-disabled" : ""}`,
                children: isUploading ? "正在上传..." : "添加文档"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-card-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "知识库 ID (Dataset ID)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-inline", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
                ...
                placeholder: "请输入 Dify Dataset ID"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-core-gradient settings-inline-button", onClick: handleBindKnowledgeBase, children: "绑定到账号" })
          ] }),
          uploadStatus && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `status-text ${uploadStatus.includes("失败") ? "status-text-error" : "status-text-success"}`, children: uploadStatus })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card settings-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "settings-card-title", children: "系统配置" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-card-subtitle", children: "连接后端与鉴权信息" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-card-body", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "中转后端地址" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "租户 ID" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "用户 Token" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "password",
